...
namespace LethalBots.Patches.MapHazardsPatches
{
    ...
    public class SpikeRoofTrapPatch
    {
        ...
        //    // Ok, supposivly I can get the parent object and not have to do looping on my side.
        //    // Lets see if this works.......
        //    Transform rootTransform = __instance.transform.root;
        //    if (rootTransform != null)
        //    {
        //        TerminalAccessibleObject terminalAccessibleObject = rootTransform.GetComponentInChildren<TerminalAccessibleObject>();
        //        if (terminalAccessibleObject == null)
        //        {
        //            Plugin.LogDebug($"Spike Roof Trap object {__instance}, had no TerminalAccessibleObject!?");
        //        }
        //        else
        //        {
        //            Plugin.LogDebug($"Spike Roof Trap object {__instance}, has and TerminalAccessibleObject!!! YAY!");
        //        }
        //    }
        //    else
        //    {
        //        Plugin.LogDebug($"Spike Roof Trap object {__instance}, has no root on its transform.......");
        //    }
